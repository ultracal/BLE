...
/**
 * @file DTM_main.c
 * @brief This application configures a BlueNRG-1,2 device as a network coprocessor (SPI or UART) in order to be used with the BlueNRG GUI or other instruments as CBT. Basic stack modular configuration option is used.
 * 
...
* \section ATOLLIC_project ATOLLIC project
  ...
  -# On project preprocessor options set BLE_STACK_CONFIGURATION=BLE_STACK_BASIC_CONFIGURATION for selecting Basic stack modular configuration option.
...
- \c Release_SPI - Network coprocessor configuration: SPI mode
- \c Release_UART_16MHz - Network coprocessor configuration: UART mode and 16MHz crystal
- \c Release_UART_32MHz - Network coprocessor configuration: UART mode and 32MHz crystal
...
@table
|            |                                    Release_UART_32MHz                                     ||||                                    Release_UART_16MHz                                     ||||                                    Release_SPI                                    ||||
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|  PIN name  |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |   STEVAL-IDB007V1  |   STEVAL-IDB007V2  |   STEVAL-IDB008V1  |   STEVAL-IDB008V2  |
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
|            |                                    Release_UART_32MHz                                     ||||                                    Release_UART_16MHz                                     ||||                                    Release_SPI                                    ||||
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|  LED name  |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |   STEVAL-IDB007V1  |   STEVAL-IDB007V2  |   STEVAL-IDB008V1  |   STEVAL-IDB008V2  |
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
|                |                                    Release_UART_32MHz                                     ||||                                    Release_UART_16MHz                                     ||||                                    Release_SPI                                    ||||
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
|   BUTTON name  |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |    STEVAL-IDB007V1   |    STEVAL-IDB007V2   |    STEVAL-IDB008V1   |    STEVAL-IDB008V2   |   STEVAL-IDB007V1  |   STEVAL-IDB007V2  |   STEVAL-IDB008V1  |   STEVAL-IDB008V2  |
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
|      RESET     |    Reset BlueNRG1    |    Reset BlueNRG1    |    Reset BlueNRG2    |    Reset BlueNRG2    |    Reset BlueNRG1    |    Reset BlueNRG1    |    Reset BlueNRG2    |    Reset BlueNRG2    |   Reset BlueNRG1   |   Reset BlueNRG1   |   Reset BlueNRG2   |   Reset BlueNRG2   |
...
Two network coprocessor configurations are available:
 - UART (DTM binary file: DTM_UART_16MHz.hex; DTM_UART_32MHz.hex is also availalble for 32MHz crystal)
 - SPI  (DTM binary file: DTM_SPI.hex)

DTM_UART_16MHz.hex and DTM_SPI.hex binary image files are built for also including the
...
Once the STEVAL-IDB007V1, BlueNRG-1 platform has been configured as network coprocessor (using DTM_UART_16MHz.hex or DTM_SPI.hex binary files), 
or STEVAL-IDB008V1, BlueNRG-2 platform has been configured as network coprocessor (using DTM_UART_32MHz.hex or DTM_SPI.hex binary files), 
